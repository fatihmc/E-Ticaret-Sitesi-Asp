...
{
    public partial class lokum : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string sorgu = "SELECT TOP 6 * FROM Products WHERE CategoryId=4";
            ...
            ListViewLokum.DataSource = dt;
            ListViewLokum.DataBind();

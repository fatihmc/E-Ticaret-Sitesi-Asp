...
{
    public partial class kuruyemis : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string sorgu = "SELECT TOP 6 * FROM Products WHERE CategoryId=0";
            ...
            ListViewKuruYemis.DataSource= dt;
            ListViewKuruYemis.DataBind();

...
{
    public partial class yoresel : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string sorgu = "SELECT TOP 6 * FROM Products WHERE CategoryId=2";
            ...
            ListViewYoresel.DataSource = dt;
            ListViewYoresel.DataBind();

<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="lokum.aspx.cs" Inherits="itpwebsite.lokum" %>
<asp:Content ID="Content1" ContentPlaceHolderID="icerik" runat="server">
    <form id="form1" runat="server">
        <asp:ListView ID="ListViewLokum" runat="server" GroupItemCount="3" OnSelectedIndexChanged="ListView1_SelectedIndexChanged">
            <EmptyItemTemplate>
                <td runat="server" />
            </EmptyItemTemplate>
            <GroupTemplate>
